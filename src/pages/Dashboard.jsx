...
const Dashboard = () => {
  ...
  if (loadingWeather)
    return <div className="p-10 text-center text-gray-600">Loading weather...</div>;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              {/* <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {weather.forecast.forecastday.map((day, i) => (
                  ...
                  >
                    ...
                    <p className="mt-1">
                      <b>{day.day.maxtemp_c}°</b> / {day.day.mintemp_c}°
                    </p>
                  </div>
                ))}
              </div> */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link
                to="/upload"
                className="bg-green-50 rounded-xl p-6 shadow hover:scale-[1.02] transition"
              >
                ...
                <p className="text-gray-600 text-sm">
                  Upload plant images & detect diseases instantly.
                </p>
              </Link>

              <Link
                to="/pest-detection"
                className="bg-green-100 rounded-xl p-6 shadow hover:scale-[1.02] transition"
              >
                <div className="flex items-center text-xl font-semibold mb-2">
                  <Bug className="mr-2 text-lime-700" /> Pest Detection
                </div>
                <p className="text-gray-600 text-sm">
                  Identify pests and get management advice.
                </p>
              </Link>

              <Link
                to="/market-trends"
                className="rounded-xl bg-gradient-to-br from-green-50 to-green-100 p-6 shadow-md hover:scale-[1.02] transition"
              >
                <div className="text-xl font-semibold text-green-800 mb-2">
                  Market Trends
                </div>
                <p className="text-gray-700 text-sm">
                  Get latest market prices and insights.
                </p>
              </Link>

              <Link
                to="/crop-calendar"
                className="rounded-xl bg-gradient-to-br from-yellow-50 to-yellow-100 p-6 shadow-md hover:scale-[1.02] transition"
              >
                <div className="text-xl font-semibold text-yellow-800 mb-2">
                  📅 Crop Calendar
                </div>
                <p className="text-gray-700 text-sm">
                  Month-wise farming tasks, operations & crop stages.
                </p>
              </Link>
            </div>
          </div>
              ...
              <div className="space-y-4 mt-4">
                {schemes.length ? (
                  schemes.map((scheme, i) => (
                    <div
                      key={i}
                      className="border p-4 rounded-lg hover:border-blue-300"
                    >
